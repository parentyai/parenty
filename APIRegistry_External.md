...
| zocdoc | 医療 | `https://developers.zocdoc.com/` | `https://developers.zocdoc.com/` | `https://www.zocdoc.com/about/terms` | `https://www.zocdoc.com/about/privacy` | （非公開） | Docs/Terms/Privacy を週次監視（Terms/Privacyは手動レビュー想定） | 事実: zocdoc.com は機械巡回で 403 になりやすい（URLは正だが監視手段が課題）。手動確認で到達可（2026-01-15）。参考: 旧Docs候補（`zocdoc.com/about/api`）は機械巡回で403 |
